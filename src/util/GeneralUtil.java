...
public class GeneralUtil {
	...
	/**
	 * Finds the index of a givenelemtn in an array of elements and returns it.
	 * 
	 * @param <T> The type of the objects and the value.
	...
	/**
	 * 
	 * Converts an array two dimensional intro one dimensional array.
	 * @param <T>
	 * 
